...
"2048/$fDAT" using 1:2 with lines lw 2 title "slow\\\\_2038", \
"2048/$fDAT" using 1:4 with lines lw 2 title "fast\\\\_2038", \
...
"2048/$fDAT" using 1:3 with lines lw 2 title "slow\\\\_2038", \
"2048/$fDAT" using 1:5 with lines lw 2 title "fast\\\\_2038", \
